...
public class StructureLoader : MonoBehaviour
{
    ...
    void GenerateTileMap()
    {
        ...
        TileBase[,] tileArray = new TileBase[50, 50];
        for (int x = 0; x < 50; x++)
        {
            for (int y = 0; y < 50; y++)
            {
                ...
                if (x < 30 && y < 30 && (x + y) % 4 == 0) {
                    tilemap.SetTile(currentPos, tileExtension);
                }
    ...
    public void GetStructuresFromConnection()
    {
